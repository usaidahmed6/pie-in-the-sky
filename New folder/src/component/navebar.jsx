                ...
                <Container fluid>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        <Nav
                            ...
                            navbarScroll
                        >
                            <Nav.Link> <Link to='/' className='link-mobile'> Home </Link> </Nav.Link>
                            <Nav.Link > <Link to='/Add_Items' className='link-mobile'> Add Items</Link> </Nav.Link>
                            <Nav.Link >  <Link to="/New_Orders" className='link-mobile'> New Orders </Link> </Nav.Link>
                            <Nav.Link > <Link to="/Accepted_Orders" className='link-mobile'> Accepted Orders </Link> </Nav.Link>
                            <Nav.Link > <Link to="/Rejected_Orders" className='link-mobile'>  Rejected Orders </Link> </Nav.Link>
